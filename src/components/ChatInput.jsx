    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between relative">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-2 px-2 py-1 md:px-3 md:py-1.5 rounded-full border border-white/10 bg-white/10"
            >
              <img
                src={webIcon}
        ...
        <textarea
          ...
          rows={2}
          className="w-full resize-none bg-transparent outline-none text-xs sm:text-sm text-white"
        />
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          <div className="flex gap-3 sm:gap-4">
            ...
            <a
              href="#"
              className="flex items-center gap-2 text-xs sm:text-sm text-white/60 hover:text-white transition"
            >
              <img
                src={attach}
                className="w-3.5 h-3.5 sm:w-4 sm:h-4"
